"""
Django settings for mcs_django_pj project.
...
SECRET_KEY = 'django-insecure-j2&f#^uual0-5+8lf%q@_seg_=o0xwk0w_gu$17siu=k0_-564'
...
# LOGIN_REDIRECT_URL = 'one_one_app:home'  # ログイン成功後の遷移先の指定
# ACCOUNT_LOGOUT_REDIRECT_URL = 'one_one_app:welcome'  # ログアウト成功後の遷移先の指定
...
ROOT_URLCONF = 'mcs_django_pj.urls'
...
WSGI_APPLICATION = 'mcs_django_pj.wsgi.application'
